...
var serviceAccountFileName * = "" ## Name of the file, which holds your Google service account oauth2
## Always keep this file in a safe location, as it holds a lot of sensitive data!
